local _0x9f1a = {_0xb2 = game:GetService("CoreGui"), _0xc4 = game:GetService("TweenService"), _0xd6 = game:GetService("UserInputService")}
local _0x3e2b = {}
_0x3e2b.__index = _0x3e2b

function _0x3e2b.Crear(_0x1a, _0x2b, _0x3c, _0x4d)
    local self = setmetatable({}, _0x3e2b)
    self.Nombre = _0x1a.Nombre or "\x4d\x34\x74\x65\x6f"
    self.Subtitulo = _0x1a.Subtitulo or "\x44\x65\x20\x6d\x61\x74\x65\x6f"
    self.KeySistem = _0x1a.KeySistem or "\x4e\x6f"
    self.Key = _0x1a.Key or "\x4d\x34\x74\x65\x6f"
    
    if self.KeySistem == "\x53\x69" then
        self:_0x7fKeySys()
    else
        self:_0x8aBuild()
    end
...
function _0x3e2b:_0x8aBuild()
    ...
    _0x7d.Text = self.Nombre .. "\x20\x7c\x20" .. self.Subtitulo
...
function _0x3e2b:CrearPestaña(_0x4e)
    local _0xGuiMain = _0x9f1a._0xb2:FindFirstChild("\x4d\x34\x74\x65\x6f\x48\x75\x62")
    local _0x5b = _0xGuiMain and _0xGuiMain:FindFirstChildOfClass("Frame")
    local _0x0a = _0x5b and _0x5b:FindFirstChildOfClass("ScrollingFrame")
    local _0x1b = _0x5b and _0x5b:FindFirstChild("\x50\x61\x67\x65\x73")
    ...
    if _0x1b then _0x60.Parent = _0x1b end
